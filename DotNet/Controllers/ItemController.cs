    ...
    public class ItemController : Controller
    {
        ...
        public IActionResult Edit(int id, ItemDto itemDto)
        {
            ...
            if (itemDto.ImageFiles != null && itemDto.ImageFiles.Any())
            {
                ...
                // Save new image filenames as comma-separated string
                item.ImageFileNames = string.Join(",", newImageFileNames);
            }
            else
            {
                // Retain old image filenames if no new images are provided
                newImageFileNames = item.ImageFileNames.Split(',').ToList();
            }
